...
print(movimentacao3)
 """
""" Classe para gerenciar as transações do usuário, permitindo adicionar ou excluir transações. """
...
class ControleFinanceiro:
    ...
    def adicionaTransacao(self, transacao: Transacao):
        if isinstance(transacao, Transacao):
            ...
            print("Transação adicionda com sucesso")
        else: print("Erro! Apenas objetos do tipo transacao")
